...
public class PessoaFisica extends JFrame {
	...
	{ // group impede marcar mais de uma op�ao no mesmo objeto
	...
	public PessoaFisica() {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(rdbsexo[0].isSelected()) pessoaFisica.setSexo('F');
				else if(rdbsexo[1].isSelected()) pessoaFisica.setSexo('M');
				else pessoaFisica.setSexo('N');
