...
public class TelaCadPessoa extends TelaCadPessoa{
	...
	public TelaCadPessoa() {
		...
		this.btnLimpar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				TelaCadPessoa.this.limparFormulario();
			}
		});
	...
	void Salvar() {
		...
		try {
			...
			c1.setTelefone(txtFone.getText());
